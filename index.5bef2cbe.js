...
var $cd9c8abf8e689b92$exports = {};
/*! choices.js v10.1.0 | © 2022 Josh Johnson | https://github.com/jshjohnson/Choices#readme */ (function webpackUniversalModuleDefinition(root, factory) {
    $cd9c8abf8e689b92$exports = factory();
})(window, function() {
    return /******/ function() {
        /******/ "use strict";
 ...
 */ var Choices1 = /** @class */ function() {
   ...
   */ Choices.prototype.setChoices = function(choicesArrayOrFetcher, value, label, replaceChoices) {
                    ...
                    Choices.prototype._createItemsFragment = function(items, fragment) {
                        ...
                        var _a1 = this.config, shouldSortItems = _a1.shouldSortItems, sorter = _a1.sorter, removeItemButton = _a1.removeItemButton; // If sorting is enabled, filter items
 ...
 */ var diff = function(a, b) {
        ...
        */ return __spreadArray(__spreadArray([], state, true), [
            ...
            /***/ 744: /***/ function(__unused_webpack_module, exports, __webpack_require__) {
                ...
                /* eslint-disable @typescript-eslint/no-explicit-any */ var redux_1 = __webpack_require__(857);
 ...
 */ function isArray(value) {
                ...
                class FuseIndex {
                    constructor({ getFn: getFn = Config.getFn , fieldNormWeight: fieldNormWeight = Config.fieldNormWeight  } = {}){
                ...
                function createIndex(keys, docs, { getFn: getFn = Config.getFn , fieldNormWeight: fieldNormWeight = Config.fieldNormWeight  } = {}) {
                ...
                function parseIndex(data, { getFn: getFn = Config.getFn , fieldNormWeight: fieldNormWeight = Config.fieldNormWeight  } = {}) {
                ...
                function computeScore$1(pattern, { errors: errors = 0 , currentLocation: currentLocation = 0 , expectedLocation: expectedLocation = 0 , distance: distance = Config.distance , ignoreLocation: ignoreLocation = Config.ignoreLocation  } = {}) {
                ...
                class BitapSearch {
                    constructor(pattern1, { location: location = Config.location , threshold: threshold = Config.threshold , distance: distance = Config.distance , includeMatches: includeMatches = Config.includeMatches , findAllMatches: findAllMatches = Config.findAllMatches , minMatchCharLength: minMatchCharLength = Config.minMatchCharLength , isCaseSensitive: isCaseSensitive = Config.isCaseSensitive , ignoreLocation: ignoreLocation = Config.ignoreLocation  } = {}){
                        this.options = {
                            location: location,
                            threshold: threshold,
                            distance: distance,
                    ...
                    searchIn(text) {
                        ...
                        this.chunks.forEach(({ pattern: pattern , alphabet: alphabet , startIndex: startIndex  })=>{
                            const { isMatch: isMatch , score: score , indices: indices  } = search(text, pattern, alphabet, {
 ...
 */ class ExtendedSearch {
                    constructor(pattern, { isCaseSensitive: isCaseSensitive = Config.isCaseSensitive , includeMatches: includeMatches = Config.includeMatches , minMatchCharLength: minMatchCharLength = Config.minMatchCharLength , ignoreLocation: ignoreLocation = Config.ignoreLocation , findAllMatches: findAllMatches = Config.findAllMatches , location: location = Config.location , threshold: threshold = Config.threshold , distance: distance = Config.distance  } = {}){
                        this.query = null;
                        this.options = {
                            isCaseSensitive: isCaseSensitive,
                            includeMatches: includeMatches,
                ...
                function parse(query1, options, { auto: auto = true  } = {}) {
                    const next = (query)=>{
                ...
                function computeScore(results, { ignoreFieldNorm: ignoreFieldNorm = Config.ignoreFieldNorm  }) {
                ...
                function format(results, docs, { includeMatches: includeMatches = Config.includeMatches , includeScore: includeScore = Config.includeScore  } = {}) {
                    const transformers = [];
...
const $2cf52be1bf24d93a$export$9db4b5520190d155 = [
    {
...
const $2cf52be1bf24d93a$export$e4346b29a12db290 = {
    Draft: "draft",
    Completed: "completed"
};


function $873326f8ef35edcd$export$2e2bcd8739ae039(form) {
    const constructElement = new FormData(form);
    const values = {};
    for (let [name, value] of constructElement)values[name] = value;
    return values;
}


//import "choices.js/public/assets/styles/choices.min.css";
const $3da87ddc4a220fcd$var$form = document.querySelector("#international-delivery-form");
const $3da87ddc4a220fcd$var$selectFrom = $3da87ddc4a220fcd$var$form.querySelector(`[name="from"]`);
const $3da87ddc4a220fcd$var$selectTo = $3da87ddc4a220fcd$var$form.querySelector(`[name="to"]`);
const $3da87ddc4a220fcd$var$selectFromObj = new (0, (/*@__PURE__*/$parcel$interopDefault($cd9c8abf8e689b92$exports)))($3da87ddc4a220fcd$var$selectFrom);
const $3da87ddc4a220fcd$var$selectToObj = new (0, (/*@__PURE__*/$parcel$interopDefault($cd9c8abf8e689b92$exports)))($3da87ddc4a220fcd$var$selectTo);
fetch("http://localhost:3000/countries").then((response)=>response.json()).then((countriesData)=>{
    ...
    $3da87ddc4a220fcd$var$selectFromObj.setChoices(countries);
    $3da87ddc4a220fcd$var$selectToObj.setChoices(countries);
});
//========================================
const $3da87ddc4a220fcd$var$tabsBtn = document.querySelectorAll(".tabs__btn");
$3da87ddc4a220fcd$var$tabsBtn.forEach(function(btn) {
    btn.addEventListener("click", function() {
        if (btn === "click") {
            btn.classList.remove("tabs__btn--disable");
            btn.classList.add("tabs__btn--active");
        } else btn.classList.add("tabs__btn--disable");
    });
});
//=======================================
const $3da87ddc4a220fcd$var$selectTypeBtn = $3da87ddc4a220fcd$var$form.querySelector(".select__btn");
const $3da87ddc4a220fcd$var$selectInner = $3da87ddc4a220fcd$var$form.querySelector(".select__inner");
const $3da87ddc4a220fcd$var$parcelType = $3da87ddc4a220fcd$var$form.querySelector(`[name="parcelType"]`);
$3da87ddc4a220fcd$var$selectTypeBtn.addEventListener("click", function(event) {
    $3da87ddc4a220fcd$var$selectTypeBtn.classList.toggle("select__btn--open");
    $3da87ddc4a220fcd$var$selectInner.classList.toggle("select__inner--open");
});
$3da87ddc4a220fcd$var$selectInner.addEventListener("click", function(event) {
    const buttonBox = event.target.closest(".select__box-btn");
    if (buttonBox !== null) {
        $3da87ddc4a220fcd$var$selectTypeBtn.innerHTML = buttonBox.innerHTML;
        $3da87ddc4a220fcd$var$selectInner.classList.remove("select__inner--open");
        $3da87ddc4a220fcd$var$selectTypeBtn.classList.remove("select__btn--open");
        $3da87ddc4a220fcd$var$parcelType.value = buttonBox.value;
        $3da87ddc4a220fcd$var$parcelType.dispatchEvent(new Event("change", {
            bubbles: true
        }));
    }
});
//==================================================
const $3da87ddc4a220fcd$var$tabsOptions = $3da87ddc4a220fcd$var$form.querySelector(".tabs__options");
const $3da87ddc4a220fcd$var$computation = $3da87ddc4a220fcd$var$form.querySelector(".computation");
const $3da87ddc4a220fcd$var$lengthInput = $3da87ddc4a220fcd$var$form.querySelector(`[name="length"]`);
const $3da87ddc4a220fcd$var$widthInput = $3da87ddc4a220fcd$var$form.querySelector(`[name="width"]`);
const $3da87ddc4a220fcd$var$heightInput = $3da87ddc4a220fcd$var$form.querySelector(`[name="height"]`);
const $3da87ddc4a220fcd$var$weightInput = $3da87ddc4a220fcd$var$form.querySelector(`[name="weight"]`);
const $3da87ddc4a220fcd$var$computationChoice = $3da87ddc4a220fcd$var$form.querySelector(".computation__choice");
$3da87ddc4a220fcd$var$form.addEventListener("change", function(event) {
    if ($3da87ddc4a220fcd$var$selectFrom.value !== "" && $3da87ddc4a220fcd$var$selectTo.value !== "" && $3da87ddc4a220fcd$var$parcelType.value !== "") $3da87ddc4a220fcd$var$tabsOptions.classList.add("tabs__options--open");
    if ($3da87ddc4a220fcd$var$parcelType.value !== "parcel") {
        $3da87ddc4a220fcd$var$weightInput.value = $3da87ddc4a220fcd$var$parcelType.value === "envelope-small" ? "0.3" : "0.5";
        $3da87ddc4a220fcd$var$weightInput.readonly = true;
    } else $3da87ddc4a220fcd$var$weightInput.readonly = false;
});
$3da87ddc4a220fcd$var$form.addEventListener("input", function(event) {
    if ($3da87ddc4a220fcd$var$lengthInput.value !== "0" && $3da87ddc4a220fcd$var$widthInput.value !== "0" && $3da87ddc4a220fcd$var$heightInput.value !== "0" && $3da87ddc4a220fcd$var$weightInput.value !== "0") $3da87ddc4a220fcd$var$computation.classList.add("computation--open");
});
$3da87ddc4a220fcd$var$form.addEventListener("submit", function(event) {
    event.preventDefault();
    const submitType = event.submitter.value;
    if (submitType === "calc") $3da87ddc4a220fcd$var$computationChoice.classList.remove("computation__choice--hide");
    else {
        const values = (0, $873326f8ef35edcd$export$2e2bcd8739ae039)($3da87ddc4a220fcd$var$form);
        values.delivery = event.submitter.value;
        values.sendingType = "international"; // вручну додаємо вид пересилки
        values.status = (0, $2cf52be1bf24d93a$export$e4346b29a12db290).Draft;
        ...
        }).then((response)=>response.json()).then(function(order) {
            debugger;
...
//==========================================
const $3da87ddc4a220fcd$var$discountButton = $3da87ddc4a220fcd$var$form.querySelector(".computation__discont-btn");
const $3da87ddc4a220fcd$var$discountModal = document.querySelector("#discount-modal");
const $3da87ddc4a220fcd$var$discountModalCloseBtn = document.querySelector(".modal__close");
$3da87ddc4a220fcd$var$discountButton.addEventListener("click", function(event) {
    $3da87ddc4a220fcd$var$openModal();
});
$3da87ddc4a220fcd$var$discountModalCloseBtn.addEventListener("click", function() {
    $3da87ddc4a220fcd$var$closeModal();
});
$3da87ddc4a220fcd$var$discountModal.addEventListener("click", function(event) {
    if (event.target.classList.contains("modal")) $3da87ddc4a220fcd$var$closeModal();
});
function $3da87ddc4a220fcd$var$closeModalOnEscape(event) {
    if (event.code === "Escape") $3da87ddc4a220fcd$var$closeModal();
}
function $3da87ddc4a220fcd$var$openModal() {
    document.addEventListener("keydown", $3da87ddc4a220fcd$var$closeModalOnEscape);
    $3da87ddc4a220fcd$var$discountModal.classList.add("modal--open");
    document.body.style.overflow = "hidden";
}
function $3da87ddc4a220fcd$var$closeModal() {
    document.removeEventListener("keydown", $3da87ddc4a220fcd$var$closeModalOnEscape);
    $3da87ddc4a220fcd$var$discountModal.classList.remove("modal--open");
    document.body.style.overflow = "";
}
//====================================
const $3da87ddc4a220fcd$var$computationCustomsBtn = $3da87ddc4a220fcd$var$form.querySelector(".computation__customs-parcels-info");
const $3da87ddc4a220fcd$var$computationContent = $3da87ddc4a220fcd$var$form.querySelector(".computation__content");
$3da87ddc4a220fcd$var$computationCustomsBtn.addEventListener("click", function() {
    $3da87ddc4a220fcd$var$computationContent.classList.toggle("computation__content--hide");
}); //===================================================


//# sourceMappingURL=index.5bef2cbe.js.map
