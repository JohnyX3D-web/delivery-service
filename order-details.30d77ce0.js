...
})({"heiuS":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "3ed02e2f30d77ce0";
...
},{}],"60gXL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _choicesJs = require("choices.js");
var _choicesJsDefault = parcelHelpers.interopDefault(_choicesJs);
var _constantsJs = require("./constants.js");
var _getFormValuesJs = require("./getFormValues.js");
var _getFormValuesJsDefault = parcelHelpers.interopDefault(_getFormValuesJs);
...
fetch(`http://localhost:3000/orders/${orderId}`).then((response)=>response.json()).then(function(order) {
    ...
    fillingChoiceDay.innerText = orderDeliveryType.minDay + "-" + orderDeliveryType.maxDay;
    fillingChoiceSpeed.innerText = orderDeliveryType.express ? "\u0428\u0432\u0438\u0434\u043A\u0430" : "\u0417\u0432\u0438\u0447\u0430\u0439\u043D\u0430";
    ...
    fetch("http://localhost:3000/countries").then((response)=>response.json()).then((countriesData)=>{
        countriesData.find(function(countryItem) {
            if (countryItem.id === order.from) inputElementFrom.value = countryItem.name;
            if (countryItem.id === order.to) inputElementTo.value = countryItem.name;
        });
    });
});
//=======================================================
...
new (0, _choicesJsDefault.default)(deliveryTime);
new (0, _choicesJsDefault.default)(paymentType);
//=======================================================
form.addEventListener("submit", function(event) {
    event.preventDefault();
    const values = (0, _getFormValuesJsDefault.default)(form);
    //debugger;
    values.status = (0, _constantsJs.OrderStatus).Completed; //вручну змінюємо статус замовлення
...
},{"./constants.js":"3huJa","choices.js":"7bdLf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./getFormValues.js":"g0Tyr"}],"3huJa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"7bdLf":[function(require,module,exports) {
...
},{}],"g0Tyr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["heiuS","60gXL"], "60gXL", "parcelRequiree23a")

//# sourceMappingURL=order-details.30d77ce0.js.map
