...
var _getFormValuesDefault = parcelHelpers.interopDefault(_getFormValues);
...
const selectFromObj = new (0, _choicesJsDefault.default)(selectFrom);
const selectToObj = new (0, _choicesJsDefault.default)(selectTo);
...
selectInner.addEventListener("click", function(event) {
    ...
    if (buttonBox !== null) {
        ...
        parcelType.dispatchEvent(new Event("change", {
            bubbles: true
        }));
    }
});
...
form.addEventListener("change", function(event) {
    if (selectFrom.value !== "" && selectTo.value !== "" && parcelType.value !== "") tabsOptions.classList.add("tabs__options--open");
    if (parcelType.value !== "parcel") {
        weightInput.value = parcelType.value === "envelope-small" ? "0.3" : "0.5";
        weightInput.readonly = true;
    } else weightInput.readonly = false;
});
form.addEventListener("input", function(event) {
    if (lengthInput.value !== "0" && widthInput.value !== "0" && heightInput.value !== "0" && weightInput.value !== "0") computation.classList.add("computation--open");
});
form.addEventListener("submit", function(event) {
    event.preventDefault();
    const submitType = event.submitter.value;
    if (submitType === "calc") computationChoice.classList.remove("computation__choice--hide");
    else {
        const values = (0, _getFormValuesDefault.default)(form);
        values.delivery = event.submitter.value;
        values.sendingType = "international"; // вручну додаємо вид пересилки
        values.status = (0, _constantsJs.OrderStatus).Draft;
...
//====================================
const computationCustomsBtn = form.querySelector(".computation__customs-parcels-info");
...
},{"choices.js":"7bdLf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./constants.js":"3huJa","./getFormValues":"g0Tyr"}],"7bdLf":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequiree23a")
